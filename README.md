...
IT professional with experience in Windows administration, Active Directory, and system troubleshooting.
I build Linux and Windows virtual labs for cybersecurity practice and penetration testing.
Skilled in Windows commands, Bash, Python, and security tools, with experience scripting for testing.
I create tools, scripts, and experiments to improve system security and build safer environments.
<p align="left">
